...
export type IconName = 
  ...
  | 'loading' | 'loader' | 'star' | 'heart' | 'bookmark' | 'alert-circle'
  ...
  // Brand & Analysis
  | 'eye' | 'color-palette' | 'palette' | 'type' | 'layout' | 'logo'
  ...
  // Communication
  | 'mail' | 'message' | 'message-circle' | 'chat' | 'phone' | 'notification' | 'send'
...
const iconMap: Record<IconName, React.ReactElement> = {
  ...
  'delete': <><path d="M3 6h18M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" /><line x1="10" x2="10" y1="11" y2="17" /><line x1="14" x2="14" y1="11" y2="17" /></>,
  ...
  'pdf': <><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14,2 14,8 20,8" /><path d="M10 12a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-1z" /><path d="M15 12v4h-2" /></>,
  ...
  'logo': <><circle cx="12" cy="12" r="3" /><path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m15.5-6.5L17 7l-1.5-1.5M7.5 17.5L6 16l-1.5 1.5m0-11L6 8l1.5-1.5M17.5 17.5L16 16l1.5-1.5" /></>,
  'brand': <><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><line x1="3" x2="21" y1="6" y2="6" /><path d="M16 10a4 4 0 0 1-8 0" /></>,
  'analytics': <><path d="M3 3v18h18" /><path d="m19 9-5 5-4-4-3 3" /></>,
  'chart': <><line x1="18" x2="18" y1="20" y2="10" /><line x1="12" x2="12" y1="20" y2="4" /><line x1="6" x2="6" y1="20" y2="14" /></>,
  'graph': <><line x1="18" x2="18" y1="20" y2="4" /><polyline points="14,20 14,4" /><polyline points="10,20 10,12" /><polyline points="6,20 6,16" /></>,
  ...
  'notification': <><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></>,
